[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-c66648af7eb3fe8bc4f294546bfd86ef473780cde1dea487d3c4ff354943c9ae.svg)](https://classroom.github.com/online_ide?assignment_repo_id=9772893&assignment_repo_type=AssignmentRepo)
# Séries de Dados
...
> Dados de Filme, das bilheterias de um filme A e filme B.
...
> Não, apenas tivemos que passar a lista de séries para poder exibir.
...
> Como dito anteriormente, o VisualizadorSeries utiliza da lista de séries que passamos como paramentro para ser tratada podendo exibir os dados existente dentro da lista e assim criando o gráfico.

3. O que o polimorfismo tem a ver com o que foi feito?

> Quando as classes derivadas de uma mesma superclasse responderem a mesma mensagem, cada uma de uma forma diferente.

4. Para que então servem as interfaces (como tipo de dado)?

> Para que certas classes tenham os mesmos métodos em comum podendo ser tratadas de formas diferentes em cada classe e também para que estejam no mesmo lugar, na interface. 
